      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="font-bold text-2xl text-primary">FarmBid</div>
            <p className="text-gray-600 text-base">
              Connecting farmers and retailers through fair and transparent auctions.
            </p>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/marketplace" className="text-base text-gray-600 hover:text-primary">
                      Marketplace
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/dashboard" className="text-base text-gray-600 hover:text-primary">
                      Dashboard
                    </Link>
                  </li>
                </ul>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <a href="mailto:support@farmbid.com" className="text-base text-gray-600 hover:text-primary">
                      support@farmbid.com
                    </a>
                  </li>
                  <li>
                    <a href="tel:+15551234567" className="text-base text-gray-600 hover:text-primary">
                      +1 (555) 123-4567
                    </a>
                  </li>
                  <li>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-500 text-center">
            &copy; 2023 FarmBid, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
